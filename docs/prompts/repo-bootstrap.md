...
Use this when starting the new repo from scratch.

## Prompt

You are helping scaffold a new production-minded repo for TurboGixxer V2.
...
1. Propose the initial repo structure.
...
- Start with the recommended folder structure.
- Then explain the reasoning briefly.
- Then implement the starter scaffold.
